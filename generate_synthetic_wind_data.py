...
wind_df.to_csv(os.path.join(_DATA_DIR, 'wind_historical_synthetic.csv'), index=False)
...
plt.tight_layout()
plt.savefig(os.path.join(_OUTPUT_DIR, 'wind_profile_analysis.png'), dpi=300, bbox_inches='tight')
plt.show()
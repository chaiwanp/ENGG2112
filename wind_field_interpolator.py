...
if __name__ == "__main__":
    ...
    wind_df = pd.read_csv(os.path.join(_DATA_DIR, 'wind_historical_synthetic.csv'))
    ...
    wind_field.save(os.path.join(_DATA_DIR, 'wind_field_current.pkl'))
    ...
    for alt_m in [50, 100, 200]:
        ...
        plt.tight_layout()
        out_path = os.path.join(_OUTPUT_DIR, f'wind_field_{alt_m}m.png')
